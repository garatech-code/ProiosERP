...
export default function OperarioActionPanel({ products }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 shadow sm:rounded-lg mt-6 border-2 border-indigo-200 overflow-hidden">
      <div className="bg-indigo-50 dark:bg-indigo-900/20 px-4 py-3 border-b border-indigo-100 flex items-center gap-2">
      ...
      <div className="p-4 sm:p-6">
        <div className="space-y-4">
          {products.map((prod, idx) => (
            <div key={idx} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-200 gap-4 transition-all hover:bg-white dark:bg-slate-800 hover:shadow-sm">
              <div className="flex-1">
                <p className="font-bold text-gray-900 dark:text-white text-lg uppercase tracking-tight">{prod.product_name}</p>
              ...
              <div className="flex items-center gap-3">
                <div className="flex flex-col">
                  ...
                  <input 
                    type="number" 
                    className="w-24 p-2 border-2 border-gray-200 rounded-lg focus:border-indigo-500 outline-none font-bold text-center text-lg dark:bg-slate-800 dark:border-slate-700 dark:text-white"
