...
export default function OperationFormOtros({ id: propId, onClose, onSuccess, initialEmailData }) {
  ...
  const DRAFT_KEY = 'draft_op_otros';
      ...
      try {
        ...
        if (id) {
          ...
          setFormData({
            ...
            tipo_operacion: op.tipo_operacion || 'otros',
  ...
  return (
    ...
    >
      ...
      >
        <div className="px-4 sm:px-6 py-4 border-b border-gray-100 dark:border-slate-700 flex justify-between items-center bg-gray-50 dark:bg-slate-700/50 shrink-0">
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">
            {id ? `Editar Operación #${id}` : 'Nueva Operación (Otros)'}
          </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="Ej. Suministro general, Otros conceptos..."
                  />
                </div>
                <AutocompleteCreate
                  label="Cliente *"
            ...
            <div>
              <div className="flex justify-between items-end border-b dark:border-slate-600 pb-2 mb-4">
                ...
                <button
                  type="button"
                  onClick={addProduct}
                  className="text-sm font-bold text-indigo-600 hover:text-indigo-800 bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 dark:bg-indigo-900/30 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1"
                >
