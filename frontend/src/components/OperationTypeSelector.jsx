        ...
        <div className="p-6 md:p-8 bg-slate-50">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <button
              ...
              className="bg-white p-6 rounded-2xl border-2 border-transparent hover:border-indigo-500 hover:shadow-lg transition-all text-left group flex flex-col items-center text-center focus:outline-none focus:ring-4 focus:ring-indigo-100"
            >
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Insumos y Repuestos</h3>
            ...
            <button
              ...
              className="bg-white p-6 rounded-2xl border-2 border-transparent hover:border-emerald-500 hover:shadow-lg transition-all text-left group flex flex-col items-center text-center focus:outline-none focus:ring-4 focus:ring-emerald-100"
            >
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Químicos y Fórmulas</h3>
              <p className="text-xs text-gray-500">
            ...
            <button
              ...
              className="bg-white p-6 rounded-2xl border-2 border-transparent hover:border-amber-500 hover:shadow-lg transition-all text-left group flex flex-col items-center text-center focus:outline-none focus:ring-4 focus:ring-amber-100"
            >
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Servicios Técnicos</h3>
              <p className="text-xs text-gray-500">
