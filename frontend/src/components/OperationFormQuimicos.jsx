  ...
  return (
    <div className={`grid grid-cols-1 sm:grid-cols-12 gap-3 items-end p-4 rounded-xl border mb-3 relative group transition-colors ${
      ...
      <div className="sm:col-span-4">
        <AutocompleteCreate
          label="Producto *"
          endpoint="/inventario/products/?categoria=quimicos"
          ...
          extraCreateData={{ categoria: 'quimicos' }}
          nameField="nombre"
      ...
      <div className="sm:col-span-2">
        <label className="block text-xs font-medium text-gray-700 mb-1">Volumen Unit. (L)</label>
        <input
          type="number"
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex justify-center items-center p-2 sm:p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[95vh] flex flex-col overflow-hidden my-auto">
        ...
        <div className="px-4 sm:px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-teal-50 shrink-0">
          <h2 className="text-xl font-bold text-emerald-800">
            {id ? `Editar Operación Químicos #${id}` : 'Nueva Operación: Químicos'}
          </h2>
          <button onClick={onClose} className="text-gray-400 hover:text-gray-600 bg-emerald-100 hover:bg-emerald-200 rounded-full p-2 transition-colors">
